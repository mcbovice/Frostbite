    ...
    parse(msj) {
        ...
        try {
            ...
            switch (data[0]) {
                ...
                case '/mobile_room':
                    {
                        if (self.account.player.user_id === 1 || self.account.player.user_id === 2 || self.account.player.user_id === 6) {
                ...
                case '/aviso':
                    {
                        if (/*self.account.player.rank === 26 || self.account.player.rank === 27 || */self.account.player.user_id === 1 || self.account.player.user_id === 2 || self.account.player.user_id === 6 || self.account.player.user_id === 5) {
                            self.gameserver.forEachAccount(function (account) {
                                if (account !== null) {
                ...
                case '/ad':
                    {
                        if (self.account.player.user_id === 1 || self.account.player.user_id === 2 || self.account.player.user_id === 6 || self.account.player.user_id === 569) {
                            let self2 = self.gameserver.getAccountById(parseInt(data[1]));
                ...
                case '/gift1':
                    {
                        if (self.account.player.rank === 26 || self.account.player.rank === 27 || self.account.player.rank === 31/*self.account.player.user_id === 1*/) {
                            ...
                            if (typeof (self2) === 'undefined') {} else {
                                if (self2.player.rank === 26 || self2.player.rank === 27 || self2.player.rank === 31) {
                                    self.account.room.forPlayers(function (account) {
                                        if (typeof (account) !== 'undefined') {
                ...
                case '/All_Winners':
                    {
                        if (self.account.player.user_id === 1) {
                            ...
                            self.gameserver.db.getUsersPrixByAllWinners(parseInt(1), parseInt(3)).then(function (rows) {
                                var info_user = rows[0];
                                for (var xm in info_user) {
                                    var PrixAvatar1 = parseInt(3844);
                                    var AvatarName1 = "Duck (S.RARE) [Head]";
                                    
                                    var PrixAvatar2 = parseInt(3845);
                                    var AvatarName2 = "Duck (S.RARE) [Body]";
                            ...
                            self.gameserver.db.getUsersPrixByAllWinners(parseInt(4), parseInt(3)).then(function (rows) {
                                var info_user = rows[0];
                                for (var xm in info_user) {
                                    var PrixAvatar1 = parseInt(718);
                                    var AvatarName1 = "(RARE) Togepi";
                            ...
                            /*================================================================================================================*/
                            self.gameserver.db.getUsersPrixByAllWinners(parseInt(7), parseInt(5)).then(function (rows) {
                                var info_user = rows[0];
                                for (var xm in info_user) {
                                    var PrixAvatar1 = parseInt(2768);
                                    var AvatarName1 = "Pikachu (S.RARE)";
                            ...
                            /*================================================================================================================*/
                            self.gameserver.db.getUsersPrixByAllWinners(parseInt(12), parseInt(8)).then(function (rows) {
                                var info_user = rows[0];
                                for (var xm in info_user) {
                                    var PrixAvatar1 = parseInt(3997);
                                    var AvatarName1 = "Ice (FLAG)";
                            ...
                            /*================================================================================================================*/
                            self.gameserver.db.getUsersPrixByAllWinners(parseInt(0), parseInt(30)).then(function (rows) {
                                var info_user = rows[0];
                                for (var xm in info_user) {
                                    var PrixAvatar1 = parseInt(8314);
                                    var AvatarName1 = "MiniPrix 2 2021 [Background]";
                ...
                case '/recarga':
                    {
                        if (self.account.player.user_id === 1) {
                            ...
                            else if (self2.player.CashCharger === 9) {
                                DateAvaId = parseInt(8414);
                                valido = true;
                            }   
                            else if (self2.player.CashCharger === 10) {
                                DateAvaId = parseInt(385);
                                valido = true;
                            }                           
                            else if (self2.player.CashCharger === 11) {
                                DateAvaId = parseInt(386);
                                valido = true;
                            }                                                       
                            else {
                                valido = true;
                        ...
                        if (self.account.player.user_id === 1 || self.account.player.user_id === 2) {
                            self.gameserver.forEachAccount(function (account) {
                                if (account !== null) {
                                    ...
                                    account.send([17, "¡Happy April Fools Day!", "<br><br><font color='yellow'>Feliz Día De Los Inocentes.</font><br><br><br><br><font color='cyan'>Att: <a href='https://www.facebook.com/berny.chavez.GM' target='_blank'>chavez torres</a></font>"]);
                                }
                            });
                        }
                        break;
                ...
                case '/love':
                    {
                        if (self.account.player.rank === 31 || self.account.player.rank === 26) {
                            if (data[1] !== null && data[1].length > 0) {
                ...
                case '/chat_gift':
                    {
                        if (self.account.player.user_id === 1 || self.account.player.rank === 26) {
                            if (data[1] !== null && data[1].length > 0)
                ...
                case '/end_game':
                    {
                        if (self.account.player.user_id === 1 || self.account.player.user_id === 2 || self.account.player.user_id === 7)
