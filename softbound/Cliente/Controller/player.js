...
//start_time end_time players avatar_on max_wind force_mobile name total_games last_5_minutes_games rooms maps game_mode s1 tp save_personal save_guild min_points different_mobiles gifts gp_event
        this.tournament = [this.tournament_start_time, this.tournament_end_time, 2, 0, 26, 2, "", 0, 0, 0, [9,43], 0, 0, 0, 1, 0, -10, false, [
            {
                "name":"Invisible (RARE) [Head+Body] / Tournament Gold / Custom Guild Background",
                "position":[1, 3],
                /*"leader_only":true,*/
                "avatar_id":[[119, 120],[3405]]
            },
            {
                "name":"Tournament Silver",
                "position":[2],
                "avatar_id":[[3406]]
            },
            {
                "name":"Tournament Bronze",
                "position":[3],
                "avatar_id":[[3407]]
            },
            {
                "name":"Astronaut (RARE) [Flag]",
                "position":[4],
                "avatar_id":[[880]]
            },
            {
                "name":"(RARE) Tournament(I) [Background]",
                "position":[1, 4],
                "avatar_id":[[8056]]
            }
        ], 200];
        ...
        this.lucky_egg_item = 0;
        this.lucky_egg_seg = 0;
        ...
        this.lucky_egg_sec_left = 0;
        this.lucky_egg_item = 0;
        this.lucky_egg_seg = data.lucky_egg_seg;
