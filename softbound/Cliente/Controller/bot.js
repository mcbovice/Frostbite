...
module.exports = class Bot {
                        ...
                        if (self.room.game) {
                            if (pfx.found) {
                                if (self.ss_count <= 0 && self.objetivo.player.hp < 600) {
                                    type = 2;
                                    self.ss_count = 5;
                                    self.gameserver.pushBroadcastChat(new Message.chatResponse(self, "Te ganare maldito Pollo :v", Types.CHAT_TYPE.BOT), self.room);
                                } else {
    ...
    getPosAtTime(a,b) {
        ...
        return {
            ...
            y: Math.ceil(this.pfinal.y + this.v.y * b + this.ay * b * b / 2)
        };
    }
